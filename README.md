# How To Fix Windows Not Booting from GRUB in Windows/Linux Dualboot (same EFI partition)

This is a guide on how to fix Windows not booting when selected from the GRUB menu, in a Windows/Linux dualboot, if both share the same EFI partition.
# Guide
